...
import com.calife.helpdesk.repositories.PessoaRepository;
...
public class DBService {
	...
	public void instanciaDB() {
		...
		Tecnico tec6 = new Tecnico(null, "Emir Calife", "021.590.704-32", "emircalife@gmail.com", encoder.encode("123"));
		...
		Chamado c7 = new Chamado(null, Prioridade.BAIXA, Status.ENCERRADO, "Chamado 7", "Teste chamado 6", tec6, cli5);
